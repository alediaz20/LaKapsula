...
require_once("class.dbutil_exception.inc.php");
...
*/
	...
	public function Connect(bool $secure = false) {
		try {
			...
			cLogging::Write(__FILE__ ." ".__FILE__ ." ".$e->GetMessage());
		}
		return $result;
	}
...
* @return bool. Devuelve TRUE si HAY un error!.
*/
...
* @return array/bool/null El primer registro del conjunto de resultados o false en caso que el resultado no tenga registros.
