...
const VALID_TYPE_PERMISOS = array('ADMIN' => "Administrador", 'OPER' => "Operador", 'OWNER' => "Propietario");


define("ESTADOS_VALIDOS", [
	'HAB'=>'Habilitado',
	'DES'=>'Deshabilitado',
	'ELI'=>'Eliminado'
]);
...
const ESTADOS_VALIDOS_COLORES = array(
	'HAB'=>'<span class="badge bg-light-success">Habilitado</span>',
	'DES'=>'<span class="badge bg-light-warning">Deshabilitado</span>',
	'ELI'=>'<span class="badge bg-light-danger">Eliminado</span>'
);
...
CONST ETIQUETA_NOTICIA_EDIT = array(
	"NOTICIA"=>"<small class='text-white bg-primary rounded p-2'>Noticia</small>",
	"LISTA"=>"<small class='text-white bg-primary rounded p-2'>Lista de precios</small>",
	"PROPUESTA"=>"<small class='text-white bg-primary rounded p-2'>Propuesta comercial</small>",
);

CONST FALTA_INFO = "FALTA INFORMACIÓN";

CONST DATA_TYPES = array('EMAIL','TEL','DIREC');

define("ESTADOS_PROPUESTAS", [
	'COM'=> "Completada",
	"ACT"=>"Activa",
	"CERR"=>"Cerrada",
	"BOR"=>"Borrador",
...
const ESTADOS_PROPUESTA_COLORES = array(
	'COM'=>'<span class="badge bg-light-primary">Completado</span>',
	'ACT'=>'<span class="badge bg-light-success">Activo</span>',
	'BOR'=>'<span class="badge bg-light-warning">Borrador</span>',
	'CERR'=>'<span class="badge bg-light-warning">Deshabilitado</span>',
	'CANC'=>'<span class="badge bg-light-danger">Cancelado</span>',
	'SUSP'=>'<span class="badge bg-light-danger">Suspendido</span>',
	'ELI'=>'<span class="badge bg-light-danger">Eliminado</span>'
);

CONST MODO_DESCUENTOS = array('simply'=>'simple', 'individual'=>'individual');

define("METODOS_PAGO",array("cont"=> "Contado","pagAnti"=>"Pago Anticipado","cheq"=> "Cheque","tranf"=> "Tranferencia"));

define("CAMPOS_COSTOS",array(
	"pvp"=>"PVP", 
	"PVP"=>"PVP", 
	"costo_con_iva"=>"costo_con_iva", 
	"costo_sin_iva"=> "costo_sin_iva"));

define('TIPOS_CALCULOS', ['Mark' => 'Markup', 'Porc' => "Porcentaje de descuento"]);

define("DESCUENTOS_A_PARTIR_DE", ['pvp' => "PVP", 'costo_con_iva' => "Costo con IVA", 'costo_con' => "Costo con IVA", 'costo_sin_iva' => "Costo sin IVA", 'costo_sin' => "Costo sin IVA"]);

const TYPE_NOTIFICACION = array(
	"ALER"=> "Alerta",
	"MENS"=> "Mensaje"
);